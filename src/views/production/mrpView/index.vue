  ...
  data() {
    return {
      ...
      tableHeader: [
        ...
        { label: '客户订单号', prop: 'khdd', align: 'center', minWidth: '130px', filters: [] },
        { label: '销售订单号', prop: 'soNum', align: 'center', minWidth: '130px', filters: [] },
        { label: '订单类型', prop: 'ddlx', align: 'center', minWidth: '130px', filters: [] },
        { label: '生产单号', prop: 'ssdh', align: 'center', minWidth: '140px', filters: [] },
        { label: '型号', prop: 'itemXH', align: 'center', minWidth: '90px, filters: []' },
        { label: '物料编号', prop: 'itemCode', align: 'center', minWidth: '160px', filters: [] },
        ...
        { label: '生产类型', type: 'state', prop: 'sclx', align: 'center', minWidth: '130px', filters: [] },
        { label: '生产部门', type: 'btn', prop: 'scbm', align: 'center', minWidth: '150px', filters: [] },
        { label: '仓库', type: 'tag', prop: 'ck', align: 'center', minWidth: '150px', filters: [] },
        { label: '库存', prop: 'kc', align: 'center', minWidth: '90px', filters: [] },
        { label: '计划数量', prop: 'qty', align: 'center', minWidth: '130px', filters: [] },
        { label: '数量单位', prop: 'dw', align: 'center', minWidth: '130px', filters: [] },
        { label: '损耗率', prop: 'shl', align: 'center', minWidth: '120px', filters: [] },
        { label: '损耗数', prop: 'shs', align: 'center', minWidth: '120px', filters: [] },
        { label: '生产数量', prop: 'scQty', align: 'center', minWidth: '130px', filters: [] },
        { label: '加工单价', prop: 'rprice', align: 'center', minWidth: '130px', filters: [] },
        { label: '行金额', prop: 'hje', align: 'center', minWidth: '120px', filters: [] },
        { label: '配件交期', prop: 'pjjq', align: 'center', minWidth: '130px', filters: [] },
        { label: '大类', prop: 'cz', align: 'center', minWidth: '90px', filters: [] },
        { label: '订单详情', prop: 'ddxq', align: 'center', minWidth: '130px', filters: [] },
        { label: '生产工单号', prop: 'mOnum', align: 'center', minWidth: '120px', filters: [] }
      ],
      insetData: {
        CreateID: '',
        Sonum: '',
